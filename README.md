...
השנה אני מנחה פרוייקטים משלושה סוגים עיקריים:

1. [פיתוח ומימוש אלגוריתמי חלוקה הוגנת](fair-division.md). פתוח לסטודנטים הלוקחים את הקורס [אלגוריתמים כלכליים.][alg] יכול להתפתח לעבודת מחקר לתואר שני. **חלק מהפרוייקטים בנושא זה מזכים במילגת-מחקר עם השלמת הפרוייקט.**
