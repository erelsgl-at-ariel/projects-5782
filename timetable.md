...
א. תארו את הכלים שתשתמשו בהם לצורך בניית המערכת, כגון:
...
ב. תארו את מבנה המערכת בצד *השרת* ובצד *הלקוח*:
...
ג. תארו את חלוקת-האחריות בין חברי-הצוות (כמובן כולם עוזרים לכולם, אבל לכל נושא יש אחראי/ת אחד/ת).
